...
$content['LN_SOURCES_FILTERSTRING_HELP'] = "Используйте тот же синтаксис, что и в поле поиска. Например, если вы хотите показывать только сообщения с "сервера1", используйте этот поисковый фильтр: источник:=сервер1";
...
$content['LN_CHARTS_FILTERSTRING_HELP'] = "Используйте тот же синтаксис, что и в поле поиска. Например, если вы хотите создать диаграмму для "сервер1", используйте этот фильтр: источник:=сервер1";
