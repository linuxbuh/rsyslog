...
$content['LN_ORACLE_HELP_TEXT'] = "<br><h3>Вы запросили у оракула дополнительную информацию о значении '%1' '%2'.</h3><p align=\"left\">Эта страница позволяет выполнять поиск по нескольким источникам журналов. %3<br>Общая идея состоит в том, чтобы упростить поиск информации по конкретной теме во всех местах, где она может существовать.</p><p align=\"left\">Полезным вариантом использования может быть попытка взлома, которую вы видите в веб-журнале. Нажмите на IP-адрес злоумышленника, чтобы открыть эту страницу поиска. Теперь вы можете как искать информацию о диапазоне IP-адресов, так и проверять другие журналы (например, брандмауэра или почты), если они содержат информацию о злоумышленнике. Мы надеемся, что это облегчит вам процесс анализа.</p>";
...
$content['LN_REPORTS_INFORMATION'] = "На этой странице показан список установленных и доступных отчетов, включая сохраненные конфигурации отчетов.<br/>Чтобы запустить отчет, нажмите на кнопки справа от сохраненных отчетов.<br/>Внимание! Создание отчетов может занять очень много времени в зависимости от размера вашей базы данных.";
